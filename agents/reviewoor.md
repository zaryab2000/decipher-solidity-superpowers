...
- INTERFACE_PATH: e.g., `src/interfaces/IVault.sol`
- DESIGN_DOC_PATH: e.g., `docs/designs/2025-01-15-vault-design.md`
- REVIEW_DATE: e.g., `2025-01-15`
- GIT_DIFF (optional): output of `git diff main...HEAD -- CONTRACT_PATH` for incremental reviews

If INTERFACE_PATH or DESIGN_DOC_PATH are missing, perform Stage 2 only and note the
missing context in the Stage 1 section of the report.
...
6. **Write report** — Populate the report template with all findings. Write the
